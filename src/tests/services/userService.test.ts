...
describe('UserService', () => {
  ...
  describe('getProfile', () => {
    ...
    it('should throw error for non-existent user', async () => {
      await expect(userService.getProfile('non-existent-id')).rejects.toThrow('Usuário não encontrado');
    });
  });
  ...
  describe('updateProfile', () => {
    ...
    it('should throw error for non-existent user', async () => {
      await expect(userService.updateProfile('non-existent-id', { name: 'New Name' }))
  ...
  describe('address management', () => {
    ...
    it('should update address', async () => {
      ...
      const updatedAddress = await userService.updateAddress(userId, address.id, {
